...
\begin{figure}
  \centering
  \includegraphics[height=5cm]{Oszi_Pics/freqModRing.png}
  \caption{.}
  \label{fig:bestmod}
\end{figure}
...
\begin{align}
  F_1 = F_{\varphi_1}(t_1) &= \int_{0}^{\frac{\pi}{\omega_\text{M}}} f(t,\varphi_1) \symup{d}t \\
  &= \frac{\omega_T}{\omega_M} \left( \frac12 + \frac{m}{\pi} \right) \\
  F_2 = F_{\varphi_2}(t_2) &= \int_{0}^{\frac{\pi+\delta}{\omega_\text{M}}} f(t,\varphi_2) \symup{d}t \\
