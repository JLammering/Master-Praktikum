...
\begin{align*}
  n \to p + e^- + \bar \nu.
\end{align*}
Dabei ist die Energieverteilung des Elektrons kontinuierlich, da die freiwerdende Energie beim Neutronzerfall zufällig auf Elektron und Neutrino aufgeteilt wird. Die Energieverteilung hat dann im Fall von \ce{^{32}P} die Form aus Abbildung \ref{fig:elektronenergie}.
\begin{figure}
  \centering
...
% bei einer wesentlich höheren maximalen Emissionsenergie abläuft ($E_\text{max} = \SI{2.28}{\mega\electronvolt}$ im Vergleich zu $E = \SI{0.546}{\mega\electronvolt}$ bei
