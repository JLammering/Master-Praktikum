...
%\begin{figure}
%  \centering
%  \includegraphics{ImmerDieseNorweger/DIL8.png}
%  \caption{Beschaltungsplan der im versuch verwendeten Operationsverstärker mit dem Gehäuse DIL 8 \cite{folgt}.}
%  \label{fig:opvbeschalt}
%\end{figure}
